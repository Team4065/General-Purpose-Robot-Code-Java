...
public class Constants {
    ...
    //Ramsete
    public static final double ROBOT_TRACKWIDTH = 0.141;
    public static final double RAMSETE_B = 2.0;
    public static final double RAMSETE_ZETA =  0.7;
    public static final double KS_VOLTS = 1.1232140651648732;//To be removed
    public static final double KV_VOLT_SECONDS_PER_METER = 2.2958171993801137;//To be removed
    public static final double KA_VOLT_SECONDS_SQUARED_PER_METER = -0.04163995848262118;//To be removed
    ...
    public static final double KP_DRIVE_VEL = 0;//To be removed
}
