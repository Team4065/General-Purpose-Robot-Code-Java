...
public class TalonSRX extends Motor {
    ...
    public TalonSRX(int canID){
        ...
        if(m_motor.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative) == ErrorCode.SensorNotPresent){
            m_hasEncoder = false;
        }else{
            m_hasEncoder = true;
        }
    ...
    public double getPosition(){
        ...
        return (double)m_motor.getSelectedSensorPosition() / 4096.0 * (m_isInverted ? -1.0 : 1.0);
    }
    ...
    public double getVelocity(){
        ...
        return (double)m_motor.getSelectedSensorVelocity() / 4096.0 / (100.0 / 1000.0) * (m_isInverted ? -1.0 : 1.0);
    }
